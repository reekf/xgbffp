...
Realtime publication and the 2026 archive audit use the upstream PyFLEXTRKR
package, not an independent lifecycle approximation. The adapter invokes these
official package stages:
...
The adapter supplies HRRR SBT as `tb`. A binary rain-rate compatibility field
